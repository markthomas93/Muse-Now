...
class Routine {
    ...
    init() {
        ...
        add(0b0111111,  9.0, 3.0, "Work","Morning")     // "Work from 9 to 12 on weekdays"
        add(0b0000001,  9.0, 3.0, "Work","Weekend")     // "Work from 9 to 12 on on saturday"
        add(0b0001010, 13.0, 2.0, "Work","Afternoon")   // "Work from 1 to 3 on wednesday and thurday"
        add(0b0110100, 13.0, 3.0, "Work","Afternoon")   // "Work from 1 to 4 on monday, tuesday, thursday"
